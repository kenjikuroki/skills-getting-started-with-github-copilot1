          ...
          .map((participant) => {
            ...
            return `
              <li>
                ...
                <button class="remove-participant" type="button" data-activity="${name}" data-email="${escapedParticipant}" aria-label="Remove ${escapedParticipant}" title="Remove participant">&times;</button>
              </li>
            `;
          })
          .join("");
